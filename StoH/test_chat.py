...
situation_prompt = PromptTemplate(template=situation_template, input_variables=["humidity", "temperature", "phosphorus", "nitrogen", "potassium", "image_description"])
#situation_chain = LLMChain(llm=LLM, prompt=situation_prompt, output_key="situation_analysis")

situation_chain = situation_prompt | LLM | StrOutputParser(output_key = "situation_analysis")
